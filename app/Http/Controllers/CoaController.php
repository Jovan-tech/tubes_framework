...
class CoaController extends Controller
{
    ...
    public static function fetchcoa()
    {
        $coa = Coa::getCoaDetailPerusahaan();
     ...
     * @return \Illuminate\Http\Response
     */
    public static function store(StoreCoaRequest $request)
    {
     ...
     * @return \Illuminate\Http\Response
     */
    public static function show(Coa $coa)
    {
        //
    }
     ...
     * @return \Illuminate\Http\Response
     */
    public static function update(UpdateCoaRequest $request, Coa $coa)
    {
        //
    }
