...
class Jurnal extends Model
{
    ...
    public function viewjurnalumum($id_perusahaan, $periode)
    {
    ...
    static public function viewakunbukubesar($id_perusahaan)
    {
        // periode memiliki format YYYY-MM
    ...
    // view data jurnal umum berdasarkan periode
    public function viewdatabukubesar($id_perusahaan, $periode, $akun)
    {
        // periode memiliki format YYYY-MM
        $sql = "   SELECT a.*,b.nama_akun
                    FROM jurnal a JOIN coa b 
    ...
    public function viewposisisaldonormalakun($akun)
    {
    ...
    public function viewsaldobukubesar($id_perusahaan, $periode, $akun)
    {
