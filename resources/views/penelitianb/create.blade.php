        ...
        <div class="card">
          <div class="card-body">
            <h5 class="card-title fw-semibold mb-4">Data PenelitianB</h5>
                ...
                <form action="{{ route('penelitianb.store') }}" method="post">
                    @csrf
                    <fieldset disabled>
                        <div class="mb-3"><label for="kodepenelitianblabel">Kode Penelitian B</label>
                        <input class="form-control form-control-solid" id="kode_penelitianb_tampil" name="kode_penelitianb_tampil" type="text" placeholder="Contoh: PR-001" value="{{$kode_penelitianb}}" readonly></div>
                    </fieldset>
                    <input type="hidden" id="kode_penelitianb" name="kode_penelitianb" value="{{$kode_penelitianb}}">
