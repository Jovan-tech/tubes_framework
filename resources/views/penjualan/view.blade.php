            ...
            <div class="card-body">
              <div class="row">
                ...
                <div class="d-sm-flex align-items-center justify-content-between mb-4">
                  <h5 class="card-title fw-semibold">Pengajuan Kas Keluar</h5>                    
                    <a href="{{url('penjualan/keranjang')}}" class="btn btn-success btn-icon-split">
                            <span class="icon text-white-50">
                                <i class="ti ti-shopping-cart"></i>
                            </span>
                            <span class="text">Lihat Transaksi</span>
                    </a>
                </div>
                            ...
                            <div class="col-lg-12 mb-4">
                                ...
                                <div class="card shadow">
                                    ...
                                    <a href="#collapseCardExample{{$p->id}}" class="d-block card-header py-3" data-toggle="collapse"
                                        role="button" aria-expanded="true" aria-controls="collapseCardExample{{$p->id}}">
                                    ...
                                    <div class="collapse show" id="collapseCardExample{{$p->id}}">
                                        <div class="card-body">
                                            <p>{{ $p->deskripsi }}</p>
                                            <p>
                                                <i class=""></i>&nbsp;&nbsp;Jumlah : <b id="xstok-{{$p->id}}">{{ $p->stok }}</b>
                                            </p>
                                            <p>
                                                <i class="ti ti-credit-card"></i>&nbsp;&nbsp;Rp {{ number_format($p->harga) }}
                                            </p>
                                            <a href="#" class="btn btn-primary btn-icon-split tampilmodaltambah" data-toggle="modal" data-target="#ubahModal" data-id="{{ $p->id }}">
                                                <span class="icon text-white-50">
    ...
    <div class="modal-dialog" role="document">
        ...
        <div class="modal-body">
            ...
            <input type="hidden" id="tipeproses" name="tipeproses" value="">
                ...
                <div class="mb-3 row">
                    <label for="nomerlabel" class="col-sm-4 col-form-label">Jenis</label>
                    <div class="col-sm-8">
                        <input type="text" class="form-control" id="nama_barang" name="nama_barang" readonly>
                    </div>
                </div>
                <div class="mb-3 row">
                    <label for="lantailabel" class="col-sm-4 col-form-label">Nominal</label>
                    <div class="col-sm-8">
...
<script>
      ...
      $(function(){
            $('.tampilmodaltambah').on('click', function(){
              ...
              $('#labelmodalubah').html('Tambah Data Transaksi');
