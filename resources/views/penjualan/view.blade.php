                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="d-sm-flex align-items-center justify-content-between mb-4">
                                <h5 class="card-title fw-semibold">Pengajuan Dana / Penelitian</h5>

                                <a href="{{ url('penjualan/keranjang') }}?dana={{ $danaParam }}"
                            ...
                            @foreach ($dana as $p)
                                <div class="col-lg-6">
                                    ...
                                    <div class="card shadow mb-8">
                                        ...
                                        <a href="#collapseCardExample{{ $p->id }}" class="d-block card-header py-3"
                                            data-toggle="collapse" role="button" aria-expanded="true"
                                            aria-controls="collapseCardExample">
                                            <h6 class="m-0 font-weight-bold text-primary">
                                                {{ $p->kode_penelitian ?? $p->kode_pengabdian }}</h6>
                                        </a>
                                                ...
                                                <div class="row">
                                                    <div class="col-4">
                                                        {{-- <a data-fancybox="gallery"
                                                            href="{{ url('barang/') }}/{{ $p->foto }}">
                                                            <img width="150px" height="150px" id="x-2"
                                                                src="{{ url('barang/') }}/{{ $p->foto }}"
                                                                zn_id="79">
                                                        </a> --}}
                                                    </div>
                                                    ...
                                                    <div class="col-4" align="justify">
                                                        ...
                                                        <a href="#"
                                                            class="btn btn-primary btn-icon-split tampilmodaltambah"
                                                            data-toogle="modal" data-target="#ubahModal"
                                                            data-id="{{ $p->id }}" data-kode-penelitian="{{ $p->kode_penelitian ?? $p->kode_pengabdian }}">
                                                            <span class="icon text-white-50">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <form action="#" class="formpenjualan" method="post">
                                @csrf
                                <input type="hidden" id="idkegiatanhidden" name="idkegiatanhidden" value="">
                                <input type="hidden" id="tipeproses" name="tipeproses" value="">

                                <div class="mb-3 row">
                                    <label for="hargalabel" class="col-sm-4 col-form-label">Kegiatan</label>
                                    <div class="col-sm-8">                                       
                                        
                                        <div class="col-sm-8">
                                            <input type="text" readonly class="form-control" id="kegiatan" name="kegiatan">
                                        </div>
                                    </div>
                                </div>

                                <div class="mb-3 row">
                                    <label for="hargalabel" class="col-sm-4 col-form-label">Nama Kegiatan</label>
                                    <div class="col-sm-8">                                       
            ...
            <script>
                ...
                $(function() {
                    $('.tampilmodaltambah').on('click', function() {
                        ...
                        $('#labelmodalubah').html('Tambah Data Kegiatan');

                        var id = $(this).data('id');
                        var kodePenelitian = $(this).data('kode-penelitian');
                        $('#idkegiatanhidden').val(id);
                        $('#kegiatan').val(kodePenelitian);

                        var url1 = "{{ url('/penjualan/barang') }}";
                        var url2 = url1.concat("/", id);
                        var url3 = url1.concat("/", "{{ $danaParam }}");
