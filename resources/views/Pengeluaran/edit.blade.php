...
@section('konten')
    ...
    <div class="body-wrapper">
      ...
      <div class="container-fluid">
        <div class="card">
          <div class="card-body">
            <h5 class="card-title fw-semibold mb-4">Data Pengeluaran</h5>
                ...
                <form action="{{ route('pengeluaran.update', $pengeluaran->id) }}" method="post">
                    ...
                    <div class="mb-3"><label for="KodeAkunlabel">Kode Akun</label>
                        <input class="form-control form-control-solid" id="kode_akun_tampil" name="kode_akun_tampil" type="text" placeholder="Contoh: PN-001" value="{{$pengeluaran -> kode_akun}}" readonly></div>
                    </fieldset>
                    <input type="hidden" id="kode_akun" name="kode_akun" value="{{$pengeluaran -> kode_akun}}">
                    ...
                    <div class="mb-0"><label for="HeaderAkunlabel">Header Akun</label>
                        <textarea class="form-control form-control-solid" id="header_akun" name="header_akun" rows="3" placeholder="Contoh : Bank">{{old('header_akun')}}</textarea>
                    </div>
                    <br>
                    <!-- untuk tombol simpan -->
