...
@section('konten')
    ...
    <div class="body-wrapper">
      ...
      <div class="container-fluid">
        <div class="card">
          <div class="card-body">
            <h5 class="card-title fw-semibold mb-4">Data PenelitianA</h5>
                ...
                <form action="{{ route('penelitiana.update', $penelitiana->id) }}" method="post">
                    @csrf
                    @method('PUT')
                    <fieldset disabled>
                    <div class="mb-3"><label for="kodepenelitianalabel">Kode Penelitian A</label>
                        <input class="form-control form-control-solid" id="kode_penelitiana_tampil" name="kode_penelitiana_tampil" type="text" placeholder="Contoh: KA-001" value="{{$penelitiana -> kode_penelitiana}}" readonly></div>
                    </fieldset>
                    <input type="hidden" id="kode_penelitiana" name="kode_penelitiana" value="{{$penelitiana -> kode_penelitiana}}">
                    ...
                    <a class="col-sm-1 btn btn-dark  btn-sm" href="{{ url('/penelitiana') }}" role="button">Batal</a>
