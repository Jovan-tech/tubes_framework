        ...
        <div class="card">
          <div class="card-body">
            <h5 class="card-title fw-semibold mb-4">Data PenelitianA</h5>
                ...
                <form action="{{ route('penelitiana.store') }}" method="post">
                    @csrf
                    <fieldset disabled>
                        <div class="mb-3"><label for="kodepenelitianalabel">Kode PenelitianA</label>
                        <input class="form-control form-control-solid" id="kode_penelitiana_tampil" name="kode_penelitiana_tampil" type="text" placeholder="Contoh: PR-001" value="{{$kode_penelitiana}}" readonly></div>
                    </fieldset>
                    <input type="hidden" id="kode_penelitiana" name="kode_penelitiana" value="{{$kode_penelitiana}}">
