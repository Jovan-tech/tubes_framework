            ...
            <h5 class="card-title fw-semibold mb-4">Data Mitra</h5>
                ...
                <form action="{{ route('mitra.update', $mitra->id) }}" method="post">
                    ...
                    <fieldset disabled>
                        ...
                        <input class="form-control form-control-solid" id="kode_mitra_tampil" name="kode_mitra_tampil" type="text" placeholder="Contoh: PR-001" value="{{$mitra->kode_mitra}}" readonly></div>
                    </fieldset>
                    <input type="hidden" id="kode_mitra" name="kode_mitra" value="{{$mitra->kode_mitra}}">

                    <div class="mb-3"><label for="namamitralabel">Nama Mitra</label>
                    <input class="form-control form-control-solid" id="nama" name="nama" type="text" placeholder="Contoh: Bambang Pamungkas" value="{{$mitra->nama}}">
                    </div>
                    
        
                    <div class="mb-0"><label for="alamatmitralabel">Alamat Mitra</label>
                        <textarea class="form-control form-control-solid" id="alamat" name="alamat" rows="3" placeholder="Cth: Jl Pelajar Pejuan 45">{{$mitra->alamat}}</textarea>
                    </div>
                    <br>

                    <div class="mb-3"><label for="emaillabel">Email</label>
                    <input class="form-control form-control-solid" id="email" name="email" type="text" placeholder="Contoh: Bambangpamungkas@gmail.com" value="{{$mitra->email}}">
                    </div>
